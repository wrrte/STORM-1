...
def load_config(config_path):
    ...
    conf.JointTrainAgent.Retrieval.dynamic_warmup_target_steps = 1000
    ...
    conf.JointTrainAgent.Retrieval.anchor_weight = 0.4
    ...
    conf.defrost()
    # Match the incoming type before YACS merges: enable accepts "Both" or a list.
