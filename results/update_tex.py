...
EXCLUDED_SEEDS = {
    ...
    "Assault": {2010},
    "Frostbite": {10},
    "BankHeist": {2000, 6020, 6030, 6040, 6050},
    "BattleZone": {2000, 6010},
    "Boxing": {10, 6000, 6030},
    "Breakout": {2, 6010},
    "CrazyClimber": {6000, 6010, 6040},
    "Freeway": {6030},
    "Jamesbond": {9999},
    "Kangaroo": {10, 2000, 6010, 6050, 9998, 9999},
    "Krull": {2000, 2010, 6000, 6010, 6030, 6040, 6060, 6080, 6090},
    "KungFuMaster": {2010, 9999},
    "Gopher": {10, 3710, 6000, 6010, 6020, 6030, 6040, 6050, 6060, 9995, 9996, 9999}, 
    "Pong": {2010},
    "PrivateEye": {6000, 6030},
    "Qbert": {1, 3710, 6030},
    "RoadRunner": {2000, 6000, 6010, 6050, 6070},
    "UpNDown": {6020, 6040, 9999},
}
